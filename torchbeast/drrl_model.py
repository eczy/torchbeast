...
class DRRLnet(nn.Module):
    ...
    def __init__(self, num_actions, h=84, w=84, n_f_conv1 = 12, n_f_conv2 = 24,
                 att_emb_size=64, n_heads=2, n_att_stack=2, n_fc_layers=4, pad=True,
                 baseline_mode=False, n_baseMods=3, use_lstm=False):
        """
        Args:
        ...
        self.conv1 = nn.Conv2d(4, n_f_conv1, kernel_size=2, stride=1)
        ...
        self.policy = nn.Linear(256 + 1, outputs)
        self.baseline = nn.Linear(256 + 1, 1)
